# SCAFFOLD — never applied (see terraform/GCP_MIGRATION.md). Same shape as
# ../dev, env="prod". Kept green (fmt/validate) but not part of the deploy
# workflow.
...
module "app" {
  ...
  firebase_auth_domain       = "brokelads.co.uk"
