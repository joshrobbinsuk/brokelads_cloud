...
fires every minute but only between 12:00 and 22:59 Europe/London: the window keeps Neon
autosuspending overnight so free-tier compute-hours are not burnt on ingestion, while user
requests still wake it on demand at any hour.
